...
export const rootRouterConfig: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'stock-alerts',
        loadChildren: () => import('./views/stock-alerts/stock-alerts.module').then(m => m.StockAlertsModule),
        data: { title: 'Stock Alerts', breadcrumb: 'STOCK ALERTS'}
      },
  {
        path: 'expiry-alerts',
        loadChildren: () => import('./views/expiry-alerts/expiry-alerts.module').then(m => m.ExpiryAlertsModule),
        data: { title: 'Expiry Alerts', breadcrumb: 'EXPIRY ALERTS'}
      },
  {
    path: 'enhanced-items',
    loadChildren: () => import('./views/cruds/enhanced-items/enhanced-items.module').then(m => m.EnhancedItemsModule),
  ...
  },
  {
    ...
    data: { title: 'Accounting', breadcrumb: 'ACCOUNTING', roles: ['SUPER_ADMIN', 'ADMIN', 'ACCOUNTANT']}
  },
      {
        path: 'reports',
        loadComponent: () => import('./views/reports/reports.component').then(m => m.ReportsComponent),
        canActivate: [UserRoleGuard],
        data: { title: 'Reports', breadcrumb: 'REPORTS', roles: ['SUPER_ADMIN', 'ADMIN'] }
      },
      {
        path: 'others',
        loadChildren: () => import('./views/others/others.module').then(m => m.OthersModule),
        canActivate: [UserRoleGuard],
        data: { title: 'Others', breadcrumb: 'OTHERS', roles: ['SUPER_ADMIN']}
      },
      {
        path: 'tables',
